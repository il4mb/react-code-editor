...
function App() {
    ...
    const cssResolver = useCallback((word: string, { code, position }: { code: string, position: number }) => {
    ...
    return (
        <div style={{ 
            ...
            <header style={{ marginBottom: '2rem', textAlign: 'center' }}>
                <h1 style={{ fontSize: '2.5rem', fontWeight: 800, marginBottom: '0.5rem', background: 'linear-gradient(45deg, #4fc1ff, #a277ff)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                    Antigravity Code Editor
                </h1>
                <p style={{ color: '#888' }}>Premium React code editor with real-time validation & widgets</p>
            </header>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    <div style={{ fontSize: '0.9rem', fontWeight: 'bold', color: '#4fc1ff', textTransform: 'uppercase', letterSpacing: '0.1em' }}>
                        Source Code
                    </div>
                    <div style={{ border: '1px solid #333', borderRadius: '12px', overflow: 'hidden', height: '500px' }}>
                        {mode === 'css' ? (
                            <Editor
                                key="css-editor"
